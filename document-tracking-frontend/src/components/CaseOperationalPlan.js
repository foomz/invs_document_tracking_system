...
function CaseOperationalPlan() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8000/api/Coplan/')
      .then(response => {
  ...
  const handleSave = (id) => {
    ...
    axios.put(`http://localhost:8000/api/Coplan/${id}/`, item)
      .then(response => {
        setItems(prevState =>
  ...
  const handleDelete = (id) => {
    axios.delete(`http://localhost:8000/api/Coplan/${id}/`)
      .then(() => {
  ...
  const handleNewItemSave = () => {
    axios.post('http://localhost:8000/api/Coplan/', newItem)
      .then(response => {
  ...
  return (
    <div className="container">
      <h1>Case Operational Plan (COPLAN)</h1>
...
export default CaseOperationalPlan;
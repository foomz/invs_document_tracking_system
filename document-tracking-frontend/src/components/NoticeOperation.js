...
const NoticeOperation = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/api/NoticeOperation/')
      .then(response => {
  ...
  const handleBlur = (region, month, value) => {
    ...
    axios.post('http://localhost:8000/api/NoticeOperation/', payload)
      .catch(error => {
  ...
  return (
    <div className="container">
      <h1>Notice of Operation Statistics</h1>
...
export default NoticeOperation;
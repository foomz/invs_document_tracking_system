...
function NoticeOfOperation() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8000/api/NoticeOfOperation/')
      .then(response => {
  ...
  const handleSave = (id) => {
    ...
    axios.put(`http://localhost:8000/api/NoticeOfOperation/${id}/`, item)
      .then(response => {
        setItems(prevState =>
  ...
  const handleDelete = (id) => {
    axios.delete(`http://localhost:8000/api/NoticeOfOperation/${id}/`)
      .then(() => {
  ...
  const handleNewItemSave = () => {
    axios.post('http://localhost:8000/api/NoticeOfOperation/', newItem)
      .then(response => {
...
export default NoticeOfOperation;